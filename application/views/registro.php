    ...
    <div class="row">
        <div class="col-md-7 ">
            <div style="margin-right: 25%; margin-left: 25%">
                ...
                <h4 class=" m-t-20 m-b-40">Formulario de Registro</h4>
                <div id="div_signin">
                    <form id="sign_in" method="POST">
                        ...
                        <div class="form-group input-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre Completo" required autofocus>
                            </div>
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon">
                            ...
                            <div class="form-line">
                                <input type="date" class="form-control" name="fecha_nacimiento" id="fecha_nacimiento" placeholder="Fecha Nacimiento" required autofocus>
                            </div>
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon">
                        ...
                        <div class="form-group input-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control" name="tel_movil" id="celular" placeholder="Celular" required>
                            </div>
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <button class="btn btn-lg btn-block bg-blue waves-effect" type="submit">REGISTRATE</button>
                            </div>
                        </div>
                        <br>
                        <p class="text-center">¿Ya eres usuario? <a href="<?php echo base_url(); ?>">Accede</a></p>
                    </form>
                </div>
                <div id="div_confirm" class="hidden">
                <p class="text-center">Se ha enviado un email de confirmación, por favor ingrese el código de verificación</p>
                <div class="form-group input-group">
                            <span class="input-group-addon">
                                <i class="material-icons">lock</i>
                            </span>
                        ...
                        <button class="btn btn-lg btn-block bg-blue waves-effect" onclick="verificar()">VERIFICAR</button>
                </div>
                ...
                <div class="alert bg-light-green" id="success">
                    <strong>Registro Correcto!</strong> Será redirigido al sistema
                </div>
        ...
        <div class="col-md-5" style="background-image: url('<?php echo base_url(); ?>images/login_ling.png'); height:770px;">
            <div>
