<section class="content">
    <div class="container-fluid">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box hover-zoom-effect bg-red">
                        <div class="icon">
                            <i class="material-icons">shopping_cart</i>
                        </div>
                        <div class="content">
                            <div class="text">NO. CANCELACIONES</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box hover-zoom-effect bg-red">
                        ...
                        <div class="content">
                            <div class="text">TOTAL CANCELADO</div>
 ...
 <script src="<?php echo base_url() ?>js/datos/ventas_canceladas.js"></script> 